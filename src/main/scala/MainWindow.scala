...
/**
  * Main class containing the front end of the app.
  */
class MainWindow extends Application{
  override def start(primaryStage: Stage): Unit = {
    /**
      * All JavaFx components will be placed on the grid.
      */
    ...
    val windSpeedText = new Text("- m/s")
    ...
    /**
      * Information about the time and date of the last update of the weather data.
      */
    ...
    /**
      * Buttons for toggling weather source and refreshing.
      */
    ...
    /**
      * Scheduling of refreshes so that they happen every 5 minutes.
      */
    val ex = new ScheduledThreadPoolExecutor(1)
    val task = new Runnable {
      def run(): Unit = Interface refreshWeather ()
    }
    ex.scheduleAtFixedRate(task, 0, 5, TimeUnit.MINUTES)
  }
